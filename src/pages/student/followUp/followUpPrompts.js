...
- **推理歸因（錨定式 why）**：**若學生本輪（或前一輪）已給出有內容的完整短句，優先用這招**——錨定他剛說過的那句話追問一次「為什麼」，例：「你說『攪一攪糖就會不見變成水』，**怎麼會這樣想呢**？」→ 視回答推 cause 2/3/5/6
- 場景喚起：「你想到的是哪個畫面？」「廚房 / 學校 / 影片 / 想不到」→ 推 cause 5（**適用於學生只給單詞、講不出完整句時**）
