        ...
        {items.map(({ code, node, miscon, relatedQs, causeIds }) => (
          <div key={code} className="bg-white rounded-2xl border border-[#BDC3C7] p-4 shadow-[0_2px_8px_rgba(0,0,0,0.04)]">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-sm font-mono text-[#95A5A6]">{code}</span>
            ...
            <div className="bg-[#FAC8CC] border border-[#F5B8BA] rounded-xl p-3 mb-2.5">
              <p className="text-sm font-semibold text-[#E74C5E] mb-1">學生的想法</p>
              <p className="text-sm font-medium text-[#2D3436] mb-1">「{miscon.label}」</p>
              <p className="text-sm text-[#636E72] leading-relaxed">{miscon.studentDetail || miscon.detail}</p>
            </div>
            {causeIds.length > 0 && (
              <div className="bg-[#F9FBF7] border border-[#D5D8DC] rounded-xl p-3 mb-2.5">
                <p className="text-sm font-semibold text-[#636E72] mb-2">AI 分析迷思成因</p>
                <div className="flex flex-wrap gap-1.5">
                  {causeIds.map((cid) => {
                    ...
                    return (
                      <span key={cid} className={`inline-flex items-center gap-1 px-2 py-1 rounded-lg text-sm font-semibold border border-transparent ${theme.badge}`}>
            ...
            <div className="bg-[#BADDF4] border border-[#A3CCE9] rounded-xl p-3 mb-2.5">
              <p className="text-sm font-semibold text-[#2E86C1] mb-1">科學上正確的觀念</p>
            ...
            {relatedQs.length > 0 && relatedQs[0].aiSummary && (
              <div className="bg-[#FFFBF0] border border-[#F5D669] rounded-xl p-3 mb-2.5">
                <p className="text-sm font-semibold text-[#B9770E] mb-1">AI 診斷摘要</p>
            ...
            <div className="bg-[#EEF5E6] border border-[#D5D8DC] rounded-xl p-3">
              <p className="text-sm font-semibold text-[#636E72] mb-1">教學建議</p>
