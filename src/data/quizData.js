...
export const defaultQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      { tag: 'C', content: '不管加多少鹽進去，只要持續加熱或攪拌，水都能把鹽全部溶光，不會有溶不下的問題。', diagnosis: 'M05-3' },
      { tag: 'D', content: '就算用加熱讓鹽全部溶開，放一陣子後鹽還是會自己跑回杯底，所以最後一定會有溶不掉的鹽。', diagnosis: 'M05-1' },
    ],
  },
  {
    id: 4,
    ...
    options: [
      { tag: 'A', content: '用嘴巴嚐嚐看味道。', diagnosis: 'M09-4' },
