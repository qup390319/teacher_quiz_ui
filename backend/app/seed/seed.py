...
async def seed_followups(db: AsyncSession) -> int:
    ...
    for a in answers:
        ...
        # 成因 ID 已對齊新 9 類分類（見 docs/spec-09、misconceptionCauses.js）。
        # 舊→新對照：1→1, 2→2, 3→6, 4→5, 5→3, 6→4, 7→8, 8→9。
        cause_map = {
            "M02-1": [2, 3], "M02-2": [4], "M02-3": [6, 3], "M02-4": [2, 4],
            "M03-1": [6, 3], "M03-2": [5, 3], "M03-3": [6], "M03-4": [1],
            "M05-1": [6], "M05-2": [3], "M05-3": [6, 5], "M05-4": [2],
            "M09-1": [2, 4], "M09-2": [5], "M09-3": [3], "M09-4": [1, 5],
            "M12-1": [3, 4], "M12-2": [6], "M12-3": [5], "M12-4": [5, 4],
        }
