...
class CustomMisconceptionIO(BaseModel):
    ...
    label: str
    detail: str
    student_detail: str = Field(serialization_alias="studentDetail")
    confirm_question: str = Field(serialization_alias="confirmQuestion")
...
class CreateCustomMisconceptionRequest(BaseModel):
    ...
    student_detail: str = Field(min_length=1, alias="studentDetail")
    confirm_question: str = Field(min_length=1, alias="confirmQuestion")
